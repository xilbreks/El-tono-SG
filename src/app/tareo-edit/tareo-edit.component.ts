...
@Component({
  ...
  styleUrl: './tareo-edit.component.scss'
})
export class TareoEditComponent {
  idrdt: string;
  ...
  public getObjRdt(): void {
    ...
    firstValueFrom(query).then((snapshot: any) => {
      ...
      this.objRdt.idcolaborador = tareo.idUsuario;
      this.objRdt.scolaborador = tareo.nombreUsuario;
      this.objRdt.sfecha = tareo.fecha;
      this.objRdt.nsemana = 1;
      this.objRdt.ndia = 1;
